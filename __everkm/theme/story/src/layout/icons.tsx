...
export const ChevronRightIcon: Component<{ class?: string }> = (props) => (
  <svg class={props.class || "w-3 h-3 mx-1 inline-flex items-center"} viewBox="0 0 16 16" fill="currentColor">
...
export const NextArrowIcon: Component<{ class?: string }> = (props) => (
  <svg class={props.class || "inline-block"} viewBox="0 0 24 24" width="1.5em" height="1.5em">
